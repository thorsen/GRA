...
public class SVGUI3 extends JDialog {
    ...
    private void initComponents() {
        ...
        jButton7.setIcon(new ImageIcon(Toolkit.getDefaultToolkit().getImage("\\\\Bsolar\\DatosSolar\\Curva\\Imagenes\\rosa.png" )));
        ...
        jButton2.setIcon(new ImageIcon(Toolkit.getDefaultToolkit().getImage("\\\\Bsolar\\DatosSolar\\Curva\\Imagenes\\printer.png" )));
        ...
        jLabel17.setIcon(new ImageIcon(Toolkit.getDefaultToolkit().getImage("\\\\Bsolar\\DatosSolar\\Curva\\Imagenes\\Information.png" )));
